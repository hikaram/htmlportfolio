jQuery.iPikaChoose={
	build:function(user_options){
		...
		return jQuery(this).each(function(){
			...
			jQuery(this).before("<div class='pika_compare'><a href='' onclick='$(this).css(\"background-image\", \"url(/img/compare.jpg)\"); addCompare("+options.mit_id+"); return false;'>Добавить к сравнению</a></div>");
